...
const LoginPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden bg-[#030303] font-sans selection:bg-city-blue/30 selection:text-city-blue">
            ...
            {/* Cinematic Background Accents */}
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-city-blue/20 blur-[140px] rounded-full pointer-events-none animate-pulse duration-[3000ms]" />
            <div className="absolute bottom-0 left-0 w-[700px] h-[700px] bg-city-red/10 blur-[160px] rounded-full pointer-events-none" style={{ animation: "pulse 6s cubic-bezier(0.4, 0, 0.6, 1) infinite" }} />
            ...
            >
                ...
                <div className="text-center mb-10 relative">
                    ...
                    <h2 className="font-heading text-4xl font-black text-white tracking-tighter drop-shadow-md">Authorization</h2>
                    <p className="text-xs font-bold text-city-blue uppercase tracking-[0.25em] mt-3 opacity-90">CityGuardian Uplink</p>
                </div>
                ...
                <form onSubmit={onSubmit} className="space-y-6 flex flex-col">
                    <div className="group relative">
                        ...
                        <input
                            ...
                            placeholder="Email"
                            required
                            className="w-full pl-12 pr-4 py-4 bg-white/5 border border-white/10 focus:border-city-blue rounded-xl text-white placeholder-gray-500 outline-none transition-all focus:ring-4 focus:ring-city-blue/20 font-medium shadow-sm"
                        />
                    </div>
