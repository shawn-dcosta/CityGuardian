...
import { Activity, CheckCircle, Clock, MapPin, AlertTriangle, ArrowRight, Target, Hexagon, Check } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-100 dark:bg-[#0B0F15] relative font-sans">
            <div className="container mx-auto px-4 pt-10 pb-20 max-w-7xl relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between md:items-end mb-10 gap-6 relative z-10 border-b border-gray-300 dark:border-white/20 pb-5 backdrop-blur-sm">
                    ...
                    >
                        <div className="inline-flex items-center gap-3 px-3 py-1.5 bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-full mb-6 shadow-inner">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="w-1 h-3 bg-gray-300 dark:bg-white/10 hidden sm:block" />
                                <p className="text-[10px] font-black tracking-widest text-gray-500 dark:text-gray-400 uppercase leading-none">
                                    Clearance: <span className="text-city-green">Citizen</span>
                                </p>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 relative z-10">
                    ...
                    >
                        ...
                        <h3 className="font-heading text-5xl sm:text-6xl font-black text-city-black dark:text-white relative z-10 drop-shadow-sm">{stats.total}</h3>
                    </motion.div>
                    ...
                    >
                        ...
                        <h3 className="font-heading text-5xl sm:text-6xl font-black text-city-black dark:text-white relative z-10 drop-shadow-sm">{stats.pending}</h3>
                    </motion.div>
                ...
                {/* Detailed Report View - Shared Responsive Component */}
            </div>
            {/* Detailed Report View - Moved outside stacking context to resolve overlap */}
            <ReportDetailsModal
